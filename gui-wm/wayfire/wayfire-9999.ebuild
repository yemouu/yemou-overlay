...
LICENSE="MIT"
SLOT="0"
IUSE="+gles +system-wfconfig +system-wlroots elogind seatd systemd X"
REQUIRED_USE="?? ( elogind seatd systemd )"
...
DEPEND="
	...
	system-wlroots? ( >=gui-libs/wlroots-0.12.0[elogind=,seatd=,systemd=,X?] )
